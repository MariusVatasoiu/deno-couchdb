...
export function dbScope (cfg) {
  ...
  if(typeof cfg !== 'object') {
    throw new Error('You must specify the endpoint url when invoking this module');
  }
  ...
  function relax (opts, callback) {
    ...
    if (opts.form) {
      ...
      req.body = new URLSearchParams(opts.form).toString('utf8')
